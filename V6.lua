-- [[ PRO PANEL V6 - THE FINAL GHOST EDITION ]]
...
-- วิ่งเร็ว (กลับมาแล้ว!)
_G.Speed = 16
AddToggle(MainMenu, "วิ่งเร็ว", function(s)
...
AddToggle(MainMenu, "เดินทะลุ/ghost", function(s)
    ...
    if ghostActive then
        ...
        for _, v in pairs(ghostClone:GetChildren()) do
...
RunService.Stepped:Connect(function()
    if noclip and LocalPlayer.Character then
        ...
        if not antiFall then
            ...
            antiFall.Position = Vector3.new(0, -100, 0)
            antiFall.Anchored = true
            antiFall.Transparency = 0.8
...
AddInfo('Status: <font color="rgb(0,255,0)">ONLINE V6</font>')
