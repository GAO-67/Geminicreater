-- [[ PRO PANEL V9 - ULTIMATE FIX & ESP RETURN ]]
local CoreGui = game:GetService("CoreGui")
if CoreGui:FindFirstChild("GaoProV9") then
    CoreGui:FindFirstChild("GaoProV9"):Destroy()
end

local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "GaoProV9"
...
RunService.RenderStepped:Connect(function()
    ...
    -- ระบบมองทะลุที่ปรับปรุงใหม่ (ESP / Chams)
    for _, v in pairs(workspace:GetDescendants()) do
...
AddInfo('Status: <font color="rgb(0,255,0)">ONLINE V9</font>')
